...
TEST(TranslationFixer, case_missed_multp_1) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_missed_multp_2) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_missed_multp_3) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_missed_multp_4) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_missed_multp_5) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_missed_multp_6) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_unopened_bracket_1) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_unopened_bracket_2) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_unopened_bracket_3) {
  s21::Translator tr;
  std::string expected = "x*cos(x)";
  s21::list<std::string> returned = tr.Tokenize("x)cosx");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_unopened_bracket_4) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_unopened_bracket_5) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_unopened_bracket_6) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_add_brackets_1) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_add_brackets_2) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_add_brackets_3) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_add_brackets_4) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_add_brackets_5) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_add_brackets_6) {
  s21::Translator tr;
  std::string expected = "sin(2)";
...
TEST(TranslationFixer, case_add_brackets_7) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_add_brackets_8) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_operators_1) {
  s21::Translator tr;
  std::string expected = "x*~2";
...
TEST(TranslationFixer, case_operators_2) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_operators_3) {
  s21::Translator tr;
  std::string expected = "3-#4";
  s21::list<std::string> returned = tr.Tokenize("3-+4");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_operators_4) {
  s21::Translator tr;
  std::string expected = "3-~~4";
  s21::list<std::string> returned = tr.Tokenize("3---4");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_operators_5) {
  s21::Translator tr;
  std::string expected = "~3*~4";
  s21::list<std::string> returned = tr.Tokenize("-3*-4");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_operators_6) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_operators_7) {
  s21::Translator tr;
  std::string expected = "2%3";
  s21::list<std::string> returned = tr.Tokenize(" 2  %    3");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_operators_8) {
  s21::Translator tr;
  std::string expected = "x^x";
...
TEST(TranslationFixer, case_operators_9) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_operators_10) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_operators_11) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_operators_12) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_operators_13) {
  s21::Translator tr;
  std::string expected = "3-#~4";
  s21::list<std::string> returned = tr.Tokenize("3-+-4");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_scientific_1) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_scientific_2) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_scientific_3) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_scientific_4) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_scientific_5) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_1) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_2) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_3) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_4) {
  s21::Translator tr;
  std::string expected = "(1+x*sin(x))*sin(cos(1+x-cos(x)))";
...
TEST(TranslationFixer, case_other_5) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_6) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_7) {
  s21::Translator tr;
  std::string expected = "cos(~x)*cos(x)-sin(x)*cos(sqrt(sin(1-x*x+sqrt(1+cos(sin(2*x))))))";
  s21::list<std::string> returned = tr.Tokenize("cos-xcosx-sinxcossqrtsin(1-xx+sqrt(1+cossin2x))");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_other_8) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_9) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_10) {
  s21::Translator tr;
  std::string expected = "cos(x)-tg(cos(sin(sin(x*sin(1-x*x)))))+x*cos(x)";
...
TEST(TranslationFixer, case_other_11) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_other_12) {
  s21::Translator tr;
  std::string expected = "sin(~(2+x*x-sin(0)))";
  s21::list<std::string> returned = tr.Tokenize("sin~(2+xx-sin(0))");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_other_13) {
  s21::Translator tr;
  std::string expected = "sin(~(2-x*x-sin(0)))";
  s21::list<std::string> returned = tr.Tokenize("sin~(2~xx-sin(0))");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_other_14) {
  s21::Translator tr;
  std::string expected = "sin(~(2-x*x-sin(0)))";
  s21::list<std::string> returned = tr.Tokenize("  sin  ~(2~xx     -sin  (0 ))    ");
  EXPECT_EQ(expected, to_string(returned));
...
TEST(TranslationFixer, case_error_unfinished_1) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("++"), std::logic_error);
}

TEST(TranslationFixer, case_error_unfinished_2) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("2("), std::logic_error);
}

TEST(TranslationFixer, case_error_unfinished_3) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize(")("), std::logic_error);
}

TEST(TranslationFixer, case_error_unfinished_4) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("sin(x)("), std::logic_error);
}

TEST(TranslationFixer, case_error_unfinished_5) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("sin+"), std::logic_error);
}

TEST(TranslationFixer, case_error_unfinished_6) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("2sin"), std::logic_error);
}

TEST(TranslationFixer, case_error_unfinished_7) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("xsin"), std::logic_error);
}

TEST(TranslationFixer, case_error_unfinished_8) {
  s21::Translator tr;
...
TEST(TranslationFixer, case_error_mismatch_op_1) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("(*1+3"), std::logic_error);
}

TEST(TranslationFixer, case_error_mismatch_op_2) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("1+sin*2"), std::logic_error);
}

TEST(TranslationFixer, case_error_mismatch_op_3) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("cos-xcosx-sinxcos*sqrtsin-(1-xx+sqrt(1+cossin2x))"), std::logic_error);
}

TEST(TranslationFixer, case_error_mismatch_op_4) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("3-mod-.32"), std::logic_error);
}

TEST(TranslationFixer, case_error_mismatch_op_5) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("sin(+-+)"), std::logic_error);
}
...
TEST(TranslationFixer, case_error_brackets_broken_1) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("(sin)x"), std::logic_error);
}

TEST(TranslationFixer, case_error_brackets_broken_2) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("(1+)x"), std::logic_error);
}

TEST(TranslationFixer, case_error_brackets_broken_3) {
  s21::Translator tr;
  EXPECT_THROW(tr.Tokenize("()"), std::logic_error);
}

TEST(TranslationFixer, case_error_brackets_broken_4) {
  s21::Translator tr;
